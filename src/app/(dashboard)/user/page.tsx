          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{stats.total_workouts_completed}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{stats.total_exercises_completed}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{stats.current_streak} days</p>
              </div>
        ...
        {programs.length === 0 ? (
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <p className="text-gray-600 mb-2">No programs assigned yet</p>
            ...
            {programs.map((program) => (
              <Link key={program.id} href={`/user/workouts?program=${program.id}`}>
                <Card className="hover:shadow-lg transition-shadow cursor-pointer">
                  ...
                  <CardContent>
                    {program.description && <p className="text-sm text-gray-600 mb-4">{program.description}</p>}
                    <div className="flex items-center justify-between">
                      <Badge variant="info">Active</Badge>
                      <span className="text-sm text-gray-600">View Workouts →</span>
                    </div>
                  </CardContent>
                </Card>
              </Link>
