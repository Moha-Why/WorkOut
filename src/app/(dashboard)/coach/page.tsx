    ...
    <RoleGuard allowedRoles={['coach', 'admin']}>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage your training programs and users</p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="text-3xl font-bold text-gray-900 mt-2">{stats.total_exercises}</p>
            </CardContent>
          </Card>
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
              <Link href="/coach/exercises">
                <div className="p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                  <h3 className="font-bold text-gray-900 mb-2">تماريني</h3>
                  <p className="text-sm text-gray-600">Manage your exercise library</p>
                </div>
              </Link>
              ...
              <Link href="/coach/users">
                <div className="p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                  <h3 className="font-bold text-gray-900 mb-2">My Users</h3>
